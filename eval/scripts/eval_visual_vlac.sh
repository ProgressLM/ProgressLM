...
DATASET_PATH="/projects/p32958/chengxuan/ProgressLM/data/vlac_test/vlac_test.jsonl"
IMAGE_ROOT="/projects/p32958/chengxuan/ProgressLM/ref_codes/VLAC/evo_vlac/examples"

# Output configuration
OUTPUT_DIR="/projects/p32958/chengxuan/results/new_pro_bench/vlac_cases"
