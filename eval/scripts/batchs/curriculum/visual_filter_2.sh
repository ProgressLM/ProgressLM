...
DATASET_PATH="/projects/p32958/chengxuan/ProgressLM/data/train/rl/final/candidate_visual_20k.jsonl"
IMAGE_ROOT="/projects/p32958/chengxuan/data/images"

# Output configuration
BASE_OUTPUT_DIR="/projects/p32958/chengxuan/results/candidate/visual_f2"
