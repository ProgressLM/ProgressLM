...
OUTPUT_DIR="/projects/b1222/userdata/jianshu/chengxuan/saved/eval_results/raw_72B_visual_nothink"
TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
OUTPUT_FILE="${OUTPUT_DIR}/eval_visual_72b_nothink_${TIMESTAMP}.jsonl"
LOG_FILE="${OUTPUT_DIR}/eval_visual_72b_nothink_${TIMESTAMP}.log"
