#!/bin/bash
#####################################################################
# Human Activities Visual Demo - Qwen3VL-32B (NoThink)
#####################################################################
...
BASE_OUTPUT_DIR="/projects/p32958/chengxuan/results/qwen3vl/human/visual_nothink_32b"
...
echo "======================================================================"
echo "Human Activities Visual Demo - Qwen3VL-32B (NoThink)"
echo "======================================================================"
