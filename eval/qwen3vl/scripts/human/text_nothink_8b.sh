#!/bin/bash
#####################################################################
# Human Activities Text Demo - Qwen3VL-8B (NoThink)
#####################################################################
...
BASE_OUTPUT_DIR="/projects/p32958/chengxuan/results/qwen3vl/human/text_nothink_8b"
PROJECT_NAME="qwen3vl_8b_text_nothink"
...
echo "======================================================================"
echo "Human Activities Text Demo - Qwen3VL-8B (NoThink)"
echo "======================================================================"
