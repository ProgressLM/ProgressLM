...
#####################################################################
# Visual Demo Multi-View Progress Estimation - InternVL 8B
#
# This script runs progress estimation evaluation on Visual Demo dataset
# with multi-view images using InternVL 8B model.
#####################################################################
...
PROJECT_NAME="internvl_8B_multi"
...
echo "======================================================================"
echo "Visual Demo Multi-View Progress Estimation - InternVL 8B Evaluation"
echo "======================================================================"
