#!/bin/bash
#####################################################################
# Human Activities Visual Demo - InternVL 38B (Think Mode)
#####################################################################
...
BASE_OUTPUT_DIR="/projects/p32958/chengxuan/results/internvl/human/visual_38b"
...
echo "======================================================================"
echo "Human Activities Visual Demo - InternVL 38B (Think Mode)"
echo "======================================================================"
