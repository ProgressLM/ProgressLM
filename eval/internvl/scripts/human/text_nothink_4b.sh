#!/bin/bash
#####################################################################
# Human Activities Text Demo - InternVL 4B (NoThink Mode)
#####################################################################
...
BASE_OUTPUT_DIR="/projects/p32958/chengxuan/results/internvl/human/text_nothink_4b"
PROJECT_NAME="internvl_4B_text_nothink"
...
echo "======================================================================"
echo "Human Activities Text Demo - InternVL 4B (NoThink Mode)"
echo "======================================================================"
