#!/bin/bash
#####################################################################
# Human Activities Text Demo - InternVL 38B (NoThink Mode)
#####################################################################
...
BASE_OUTPUT_DIR="/projects/p32958/chengxuan/results/internvl/human/text_nothink_38b"
PROJECT_NAME="internvl_38B_text_nothink"
...
echo "======================================================================"
echo "Human Activities Text Demo - InternVL 38B (NoThink Mode)"
echo "======================================================================"
