...
#####################################################################
# Visual Edit Negation Progress Estimation - InternVL 14B
#
# This script runs progress estimation evaluation on Visual Edit negation
# dataset using InternVL 14B model with single-process model parallelism.
#####################################################################
...
BASE_OUTPUT_DIR="/projects/p32958/chengxuan/results/internvl/visual_edit_nega"
PROJECT_NAME="internvl_14B_visual_edit_nega"
...
echo "======================================================================"
echo "Visual Edit Negation Progress Estimation - InternVL 14B Evaluation"
echo "======================================================================"
