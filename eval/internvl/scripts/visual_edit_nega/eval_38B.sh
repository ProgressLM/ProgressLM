...
#####################################################################
# Visual Edit Negation Progress Estimation - InternVL 38B
#
# This script runs progress estimation evaluation on Visual Edit negation
# dataset using InternVL 38B model with single-process model parallelism.
#####################################################################
...
PROJECT_NAME="internvl_38B_visual_edit_nega"
...
echo "======================================================================"
echo "Visual Edit Negation Progress Estimation - InternVL 38B Evaluation"
echo "======================================================================"
